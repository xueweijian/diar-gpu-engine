#!/usr/bin/env python3
"""Build kaggle/m3_step3/m3_step3_run.py from the framework + fresh blobs.

Single source of truth for the Step 3 kernel: edit the C++ sources, then
run this script — it re-embeds everything and verifies the blobs are the
on-disk files (no stale-embed drift)."""
import ast
import base64
import os
import re
...
OUT = os.path.join(ROOT, 'kaggle/m3_step3/m3_step3_run.py')
...
FILES = [
    ...
    ('tools/step3_bench_main.cpp', 'cpp_bench_main'),
]
