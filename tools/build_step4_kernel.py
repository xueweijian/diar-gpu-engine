#!/usr/bin/env python3
"""Build kaggle/m4_step4/m4_step4_run.py from the framework + fresh blobs.

Single source of truth for the Step 4 kernel (MHA/conv wave + device-resident
...
OUT = os.path.join(ROOT, 'kaggle/m4_step4/m4_step4_run.py')
FRAMEWORK = os.path.join(ROOT, 'kaggle/m4_step4/framework.py')
...
FILES = [
    ...
    ('tools/step4_bench_main.cpp', 'cpp_bench_main'),
]
